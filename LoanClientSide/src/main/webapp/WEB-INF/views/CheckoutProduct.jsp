...
<body>
    <div align="center">
        <h3>Enter property Details</h3>
          <table border="1" >
        <form:form action="/checkoutProduct/" method="post" modelAttribute="product" id="difform">
           ...
           <form:hidden path="userid" />
        	...
        	<tr >
          	...
          	<tr>
                <td colspan="2" align="center"><input type="button" value="Take Loan" onclick="js()"></td>
            </tr>

        </form:form>
                </table><br>
                <a>${confirm }</a><br><br>
                <a href="/homered/${product.userid }"><input type="button" value="Back To Home" ></a>
    </div>
</body>
</html>